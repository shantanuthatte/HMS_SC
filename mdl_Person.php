...
class Person
{	
	private $fName, $mName, $lName, $address1, $rPhone, $mobile, $registrationNo, $gender, $DOB, $email;
	
	function __construct()
	{
	}
	
	function setDetails($fName, $mName, $lName, $address1, $rPhone, $mobile, $registrationNo, $gender, $DOB, $email)
	{
		$this->fName = $fName;
		$this->mName = $mName;
		$this->lName = $lName;
	...
	public function getDetails($id)
	{
		...
		$this->address1 = $row_personRS['address1'];
		...
		$data = array("personId"=>$id,"fName"=>$this->fName,"mName"=>$this->mName,"lName"=>$this->lName,"address1"=>$this->address1,
	...
	{
		include("Connections/HMS.php");
		$insertSQL = "INSERT INTO person(fName, mName, lName, address1, rPhone, mobile, registrationNo, gender, DOB, email) VALUES ($this->fName,$this->mName,$this->lName,$this->address1,$this->rPhone,$this->mobile,$this->registrationNo,$this->gender,$this->DOB,$this->email);";
		mysql_select_db($database_HMS, $HMS);
	...
	{
		include("Connections/HMS.php");
		$updateSQL = "UPDATE person SET fName=$this->fName, mName=$this->mName, lName=$this->lName, address1=$this->address1, rPhone=$this->rPhone, mobile=$this->mobile, registrationNo=$this->registrationNo, gender=$this->gender, DOB=$this->DOB, email=$this->email WHERE personId = $id";
		echo $updateSQL;
		mysql_select_db($database_HMS, $HMS);
