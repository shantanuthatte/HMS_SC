...
<div style="float:right; margin-right:50px;"><a href="AddProcedure.php"><img src="images/add.png" /></a></div>
<div style="float:right;"><a href="AddProcedure.php"><h3>  Add New</h3></a></div>
