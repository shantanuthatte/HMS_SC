...
$total_rows = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM frequency"),0);
...
mysql_select_db($database_HMS, $HMS);
$query_frequency = "SELECT * FROM frequency LIMIT $from,$rows";
	   ...
	   function populate(event) 
		{
			...
			var url = "ViewFrequency.php?rows="+number+"&page=1";
...
<div style="float:right; margin-right:50px;"><a href="AddFrequency.php"><img src="images/add.png" /></a></div>
<div style="float:right;"><a href="AddFrequency.php"><h3>  Add New</h3></a></div>
...
<!--  start paging..................................................... -->
			...
			<td>
				<a href="ViewFrequency.php?rows=<?php echo $rows; ?>&page=1" class="page-far-left"></a>
				<a href="ViewFrequency.php?rows=<?php echo $rows; ?>&page=<?php if($prev>0) echo $prev; else echo 1; ?>" class="page-left"></a>
				<div id="page-info">Page <strong><?php echo $page; ?></strong> / <?php echo $total_pages; ?></div>
				<a href="ViewFrequency.php?rows=<?php echo $rows; ?>&page=<?php if($next>1) echo $next; else echo 1; ?>" class="page-right"></a>
				<a href="ViewFrequency.php?rows=<?php echo $rows; ?>&page=<?php if($total_pages>1) echo $total_pages; else echo 1; ?>" class="page-far-right"></a>
			</td>
			</tr>
			</table>
<!--  end paging................ -->     
