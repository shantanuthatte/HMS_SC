...
// 2 - START LOGIN PAGE SHOW HIDE BETWEEN LOGIN AND FORGOT PASSWORD BOXES AND FORGOT PASSWORD AJAX--------------------------------------
...
$(document).ready(function () {
	...
	$("#forgot-form").submit(function() {
		$.ajax({
  		  type: "POST",
  		  url: "ajax.php",
  		  data: { function: "ForgotEmail", email: $("#forgot-email").val() }
		  }).done(function( msg ) {
		    $("<div title=\"Forgot Password\"><p>"+msg+"</p></div>" ).dialog({
            		modal: true,
            		buttons: {
                		Ok: function() {
                    			$( this ).dialog( "close" );
