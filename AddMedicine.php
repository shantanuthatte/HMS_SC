...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO medicine (medicineNm, content,comments) VALUES (%s, %s, %s)",
...
mysql_select_db($database_HMS, $HMS);
$query_person = "SELECT * FROM medicine";
...
<tr>
    ...
    <tr>
      <th>Medicine Name:</th>
      <td>
      <input type="text" name="medicineNm" size="32" class="inp-form-error"/>
      </td>
   		</tr>
        <tr>
      <th>Content:</th>
      <td><input type="text" name="content" value="" size="32" class="inp-form"/></td>
   		</tr>
        <tr>
      <th>Comments:</th>
