...
echo <<<'EOT'
			...
			<div class="account-drop-inner">
				<a href="" id="acc-settings">Account Settings</a>
				<div class="clear">&nbsp;</div>
		...
		<ul class="select"><li><a href="#nogo"><b>Administrator</b><!--[if IE 7]><!--></a><!--<![endif]-->
		...
		<ul class="select"><li><a href="#nogo"><b>View</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
				<li><a href="#nogo">View Medicines</a></li>
				<li><a href="#nogo">View Surgery</a></li>
				<li><a href="#nogo">View Tests</a></li>
                <li><a href="#nogo">View Ailment</a></li>
			</ul>
		</div>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
