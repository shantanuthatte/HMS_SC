...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO clinicaltest (name, comments) VALUES (%s, %s)",
...
mysql_select_db($database_HMS, $HMS);
$query_person = "SELECT * FROM clinicaltest";
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <div id="page-heading"><h1>Add ClinicalTest</h1></div>
...
<tr>
    ...
    <tr>
      ...
      <td>
      <input type="text" name="name" size="32" class="inp-form-error"/>
      </td>
   		</tr>
        <tr>
      <th>Coments:</th>
